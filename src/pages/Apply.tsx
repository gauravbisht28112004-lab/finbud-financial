...
export default function Apply() {
  ...
  const validate = (): boolean => {
    ...
    if (!form.consent) {
      e.consent = 'Please accept the privacy consent';
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // If credentials are not configured, prevent the application
    // from crashing and show the existing error state.
    if (!supabase) {
      setStatus('error');
      return;
    }
  ...
  const infoCards = [
    ...
    },
    {
      ...
      description:
        'Only essential documents needed to process your application.',
    },
    {
      icon: Clock,
      title: 'Quick Response',
      description:
        'Our team contacts you within 24 hours of submission.',
    },
  ];
        ...
        <div className="container-page">
          <div className="max-w-lg mx-auto text-center">
            ...
            <p className="text-slate-600 mb-8">
              Thank you for choosing FinBud Financial. Our team will review
              your application and contact you within 24 hours to discuss the
              next steps.
            </p>
      ...
      >
        ...
        <div className="container-page relative text-center">
          ...
          <p className="text-lg text-slate-200 max-w-2xl mx-auto">
            Fill out the form below and our team will guide you to the best
            loan offer from our lending partners.
          </p>
        </div>
      </section>
                  ...
                  <div className="flex items-start gap-3 p-4 rounded-xl bg-red-50 border border-red-200 mb-6 animate-fade-in">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-red-700">
                        Please try again or call us at our helpline.
                      </p>
                    </div>
                  </div>
                )}
                  ...
                  <div>
                    <label className="flex items-start gap-3 cursor-pointer">
                      ...
                      <span className="text-sm text-slate-600">
                        I consent to FinBud Financial contacting
                        me regarding my loan application and
                        sharing my details with lending partners.
